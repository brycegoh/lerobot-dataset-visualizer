...
import { getDatasetInfo } from "@/app/actions/dataset-info";

/**
 * Dataset information structure from info.json
 * Re-exported from server action for type compatibility
 */
export type DatasetInfo = import("@/app/actions/dataset-info").DatasetInfo;
